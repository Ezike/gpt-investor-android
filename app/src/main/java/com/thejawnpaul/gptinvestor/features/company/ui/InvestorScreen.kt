  ...
  Column {
    ...
    ElevatedCard(modifier = Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
      ...
      if (similarCompanies.value.result == null) {
        Button(
          onClick = { viewModel.getSimilarCompanies() },
        ...
        Text(text = code, Modifier.padding(start = 8.dp, top = 8.dp).fillMaxWidth())
      }
    }
      ...
      ElevatedCard(modifier = Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
        ...
        if (similarCompanies.value.result != null) {
          CompanyChoiceQuestion(
            ...
            onOptionSelected = { viewModel.compareCompanies(it) },
    ...
    AnimatedVisibility(visible = sentimentCardVisible) {
      ElevatedCard(modifier = Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
        ...
        Text(
          text = stringResource(id = R.string.uncover_prevailing_market, companyName),
          style = MaterialTheme.typography.titleSmall,
          modifier = Modifier.padding(start = 8.dp, end = 8.dp, top = 8.dp),
        )
        ...
        if (sentimentAnalysis.value.result == null) {
          Button(
            onClick = { viewModel.getSentiment() },
    ...
    AnimatedVisibility(visible = analystCardVisible) {
      ElevatedCard(modifier = Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
        ...
        Text(
          text = stringResource(id = R.string.leverage_expert_insight),
          style = MaterialTheme.typography.titleSmall,
          modifier = Modifier.padding(start = 8.dp, end = 8.dp, top = 8.dp),
        )
        ...
        if (analystRating.value.result == null) {
          Button(
            onClick = { viewModel.getAnalystRating() },
          ...
          Text(text = analystRating.value.result!!, modifier = Modifier.padding(8.dp))
        }
      }
    }
    ...
    AnimatedVisibility(visible = industryCardVisible) {
      ElevatedCard(modifier = Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
        ...
        Text(
          text = stringResource(id = R.string.explore_the_competitive_landscape),
          style = MaterialTheme.typography.titleSmall,
          modifier = Modifier.padding(start = 8.dp, end = 8.dp, top = 8.dp),
        )
        ...
        if (industryRating.value.result == null) {
          Button(
            onClick = { viewModel.getIndustryRating() },
    ...
    AnimatedVisibility(visible = finalRatingCardVisible) {
      ElevatedCard(modifier = Modifier.padding(top = 16.dp, start = 16.dp, end = 16.dp)) {
        ...
        Text(
          text = stringResource(id = R.string.synthesize_key_findings),
          style = MaterialTheme.typography.titleSmall,
          modifier = Modifier.padding(start = 8.dp, end = 8.dp, top = 8.dp),
        )
        ...
        if (finalRating.value.result == null) {
          Button(
            onClick = { viewModel.getFinalRating() },
          ...
          ExpandableRichText(text = finalRating.value.result!!, modifier = Modifier.padding(8.dp))
        }
      }
    }
    ...
    AnimatedVisibility(visible = savePdfCardVisible) {
      ElevatedCard(
        ...
        Text(
          text = stringResource(id = R.string.save_the_full_analysis),
          style = MaterialTheme.typography.titleSmall,
          modifier = Modifier.padding(start = 8.dp, end = 8.dp, top = 8.dp),
        )
        ...
        if (savePdf.value.result == null) {
          ...
          ClickableText(modifier = Modifier.fillMaxWidth().padding(8.dp), text = annotatedUrlLink) {
